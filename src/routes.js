...
const VehicleCheckType = React.lazy(() => import('./components/myaccount/admin/vehicle/checktype/listing'));
const VehicleCheck = React.lazy(() => import('./components/myaccount/admin/vehicle/check/listing'));
