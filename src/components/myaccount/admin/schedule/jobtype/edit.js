import { GetJobTypeDataById, PutJobTypeDataById } from "..//shared/jobtype";
...
let EditJobType = props => {
  ...
  async function onSubmit(values, { setSubmitting, setErrors }) {
    await PutJobTypeDataById(props.IDforAPI, values).then(()=>success()).catch(error=>errort());
    handleOpen();
    props.refresh();
    setSubmitting(false);
  }
