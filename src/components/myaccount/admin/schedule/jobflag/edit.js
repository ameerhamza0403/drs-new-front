import { GetJobflagDataById, PutJobflagDataById } from "../shared/jobflag";
...
let EditButtonForJobFlag = props => {
  ...
  async function onSubmit(values, { setSubmitting, setErrors }) {
    ...
    await PutJobflagDataById(props.IDforAPI, values).then(()=>success()).catch(error=>errort());
    handleOpen();
    props.refresh();
    setSubmitting(false);
  }
  ...
  async function getlistapi() {
    const { data: initialValues } = await GetJobflagDataById(props.IDforAPI);
  ...
  return (
    <div>
      ...
      <Modal
        ...
        size="lg"
      >
        <ModalHeader toggle={handleOpen} ><h3 className="font-weight:bold;">Edit Job Flag</h3></ModalHeader>
                  ...
                  <Col lg="12">
                    <Form onSubmit={handleSubmit} noValidate name="simpleForm">
                      ...
                      <div className="row">
                        ...
                        <div className="row">
                          <div className="col-12 col-sm-12 col-md-6 col-lg-3 col-xl-3">
                            <Label for="onDevices">On Devices</Label>
                          </div>
                          <div className="col-12 col-sm-12 col-md-6 col-lg-9 col-xl-9 mb-3">
                            ...
                            <input
                              ...
                              onBlur={handleBlur}
                              defaultChecked={initialValues.onDevices}
