...
const classes = {
  ...
  let ConditionListingEdit = props => {
...
//----- Finished Pagination---------
  ...
  if (menushow) {
    menuDiv = (
      <ul className="tool">
        <li>
          <AddWorkSheetQC refresh={refreshfn}/>
        </li>
    ...
    menuDiv = (
      <ul className="tool">
        <li />
        <AddWorkSheetQC refresh={refreshfn} idworksheet={props.IDforMainEdit}/>
      </ul>
    );
  }
    ...
    <div>
      <div className="row header">
        ...
        <div className="col-12 col-sm-6 col-md-7 col-lg-7 col-xl-7">
          <h3 className="heading">EDIT CONDITION</h3>
        </div>
      </div>
      <br />
      {EditshowModel}
...
export default ConditionListingEdit;
