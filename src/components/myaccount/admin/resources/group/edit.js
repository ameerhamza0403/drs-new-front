...
import {
  GetResourceGroupDataById,
  PutResourceGroupDataById
...
let EditGroup = props => {
  ...
  async function onSubmit(values, { setSubmitting, setErrors }) {
    await PutResourceGroupDataById(props.IDforAPI, values).then(()=>success()).catch(error=>errort());
    handleOpen();
    props.refresh();
    setSubmitting(false);
  }
  ...
  async function getlistapi() {
    const { data: initialValues } = await GetResourceGroupDataById(
      props.IDforAPI
    );
