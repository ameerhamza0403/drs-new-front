...
import EditTemplateUsageType from "./edit";
import {
  GetListingForTemplateUsageType,
  DeleteTemplateUsageTypeDataById
} from "../shared/templateusagetype";
import AddTemplateUsageType from "./add";
...
//----- Finished Pagination---------
  ...
  async function Dellistapi() {
    await DeleteTemplateUsageTypeDataById(idofEdit).then(() => {
      success();
    }).catch(error => {
        errort();
      });
  ...
  function HandlerowSelect  (row) {
    menuDiv = "";
    idofEdit = row.templateUsageTypeId;
  ...
  if (menushow) {
    ...
    menuDiv = (
      <ul className="tool">
        <li>
          <AddTemplateUsageType refresh={refreshfn} />
        </li>
    ...
    <div>
      <div className="row header">
        ...
        <div className="col-12 col-sm-6 col-md-7 col-lg-7 col-xl-7">
          <h3 className="heading">TEMPLATE USAGE TYPE</h3>
        </div>
      </div>
      <br />
      {EditshowModel}
...
export default TemplateUsageTypeListing;
