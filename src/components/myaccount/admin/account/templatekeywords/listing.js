...
import EditTemplateKeyword from "./edit";
import {
  GetListingForTemplateKeyword,
  DeleteTemplateKeywordDataById
} from "../shared/templatekeywords";
import AddTemplateKeyword from "./add";
  ...
  if (Tabledistatus) {
    Tabledisplay = (
        ...
        >
          ...
          <TableHeaderColumn dataField="mainGroup" dataSort>
            Keyword Main Group
          </TableHeaderColumn>
          <TableHeaderColumn dataField="subgroup" dataSort>
            Keyword Sub Group
          </TableHeaderColumn>
...
//----- Finished Pagination---------
  ...
  async function Dellistapi() {
    await DeleteTemplateKeywordDataById(idofEdit).then(() => {
      success();
    }).catch(error => {
        errort();
      });
  ...
  function HandlerowSelect  (row) {
    menuDiv = "";
    idofEdit = row.templateKeywordId;
  ...
  if (menushow) {
    ...
    menuDiv = (
      <ul className="tool">
        <li>
          <AddTemplateKeyword refresh={refreshfn} />
        </li>
    ...
    <div>
      <div className="row header">
        ...
        <div className="col-12 col-sm-6 col-md-7 col-lg-7 col-xl-7">
          <h3 className="heading">TEMPLATE KEYWORD</h3>
        </div>
      </div>
      <br />
      {EditshowModel}
...
export default TemplateKeywordListing;
