...
import EditTemplateUsage from "./edit";
import {
  GetListingForTemplateUsage,
  DeleteTemplateUsageDataById
} from "../shared/templateusage";
import AddTemplateUsage from "./add";
...
const options = {
  ...
  async function getlistapi() {
    await GetListingForTemplateUsage(Page, PageSize).then(res => {
  ...
  if (Tabledistatus) {
    Tabledisplay = (
        ...
        <BootstrapTable
          ...
          options={options}
        >
          <TableHeaderColumn dataField="templateUsageTypeName" dataSort>
            Usage Type
          </TableHeaderColumn>
          ...
          <TableHeaderColumn dataField="documentTypeName" dataSort>
            Document Type
          </TableHeaderColumn>
          <TableHeaderColumn dataField="defaultFormat" dataSort>
            Default Format
          </TableHeaderColumn>
...
//----- Finished Pagination---------
  ...
  async function Dellistapi() {
    await DeleteTemplateUsageDataById(idofEdit).then(() => {
      success();
    }).catch(error => {
        errort();
      });
  ...
  if (menushow) {
    console.log("sjdbjksd");
    menuDiv = (
      <ul className="tool">
        <li>
          <AddTemplateUsage refresh={refreshfn} />
        </li>
    ...
    <div>
      <div className="row header">
        ...
        <div className="col-12 col-sm-6 col-md-7 col-lg-7 col-xl-7">
          <h3 className="heading">TEMPLATE USAGE</h3>
        </div>
      </div>
      <br />
      {EditshowModel}
...
export default TemplateUsageListing;
