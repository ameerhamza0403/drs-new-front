...
let NotesFlagListingTable=(props)=> {
              ...
              {stableSort(rows, getSorting(order, orderBy))
                ...
                .map((row,index) => {
                  ...
                  return (
                    ...
                    <TableCell align="left" onClick={handleClickpop}><div className='ColorCodes' style={ColorStyleFn(row.color)}></div></TableCell>
                    <Popper
                        placement="top"
                        disablePortal={false}
                        modifiers={{
