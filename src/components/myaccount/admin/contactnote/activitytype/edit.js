import {
  GetActivityTypeDataById,
  PutActivityTypeDataById
...
let EditActivityType = props => {
  ...
  async function getlistapi() {
    const { data: editvalues } = await GetActivityTypeDataById(props.IDforAPI);
    seteditValues(editvalues);
    setModal(true);
  }

  async function putlistapi() {
    await PutActivityTypeDataById(props.IDforAPI, editvalues).then(res => success(res.data.message)).catch(error=>errort());
    handleOpen();
    props.refresh();
  }
  ...
  return (
    <div>
      ...
      >
        <ModalHeader toggle={handleOpen}>Activity Type</ModalHeader>
        <ModalBody>
