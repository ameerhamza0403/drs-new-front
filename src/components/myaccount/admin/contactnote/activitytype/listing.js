...
import { GetListingForActivityType, DeleteActivityTypeDataById } from "..//shared/activitytype";
import AddActivityType from "./add";
...
let ActivityTypeListing = () => {
    ...
    Tabledisplay = (
      ...
      <div>
        ...
        >
          ...
          <TableHeaderColumn dataField="colour" dataSort dataFormat={colorinit}>
            Color
          </TableHeaderColumn>
        </BootstrapTable>
        <br />
  ...
  async function getlistapi() {
    await GetListingForActivityType(Page, PageSize).then(res => {
  ...
  function colorinit  (cell)  {
    console.log(cell)
    return <div className="ColorCodesl" style={ColorStyleFn(cell)} />;
  };
  ...
  async function Dellistapi() {
    await DeleteActivityTypeDataById(idofEdit)
      .then(() => {
        success();
      })
      .catch(error => {
  ...
  if (menushow) {
    menuDiv = (
      <ul className="tool">
        <li>
          <AddActivityType refresh={refreshfn} />
        </li>
    ...
    <div>
      <div className="row header">
        ...
        <div className="col-12 col-sm-6 col-md-7 col-lg-7 col-xl-7">
          <h3 className="heading">ACTIVITY TYPE</h3>
        </div>
      </div>
      <br />
      {EditshowModel}
...
export default ActivityTypeListing;
