...
let AddPersonFlag = props => {
  ...
  async function onSubmit(values, { setSubmitting, setErrors }) {
    ...
    console.log(values);
    await PostListingForPersonflag(values).then(()=>success()).catch(error=>errort());
    handleOpen();
    props.refresh();
    setSubmitting(false);
  }
  ...
  return (
    <div>
      ...
      <Modal
        ...
        size="lg"
      >
        <ModalHeader toggle={handleOpen} ><h3 className="font-weight:bold;">Add Person Flag</h3></ModalHeader>
