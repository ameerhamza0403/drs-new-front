...
import { GetListingForWareHouse, DeleteWareHouseDataById } from "..//shared/warehouse";
import AddStorageLocation from "./add";
...
let WarehouseListing = () => {
    ...
    Tabledisplay = (
      ...
      <div>
        ...
        >
          ...
          <TableHeaderColumn dataField="storageLocationName" dataSort>
          Storage Location
          </TableHeaderColumn>
          <TableHeaderColumn dataField="warehouseCode" dataSort>
          Warehouse Code
          </TableHeaderColumn>
          <TableHeaderColumn dataField="storageType" dataSort>
          Storage Type
          </TableHeaderColumn>
        </BootstrapTable>
        <br />
  ...
  async function getlistapi() {
    await GetListingForWareHouse(Page, PageSize).then(res => {
  ...
  async function Dellistapi() {
    await DeleteWareHouseDataById(idofEdit)
      .then(() => {
        success();
      })
      .catch(error => {
  ...
  if (menushow) {
    menuDiv = (
      <ul className="tool">
        <li>
          <AddStorageLocation refresh={refreshfn} />
        </li>
    ...
    <div>
      <div className="row header">
        ...
        <div className="col-12 col-sm-6 col-md-7 col-lg-7 col-xl-7">
          <h3 className="heading">WAREHOUSE</h3>
        </div>
      </div>
      <br />
      {EditshowModel}
