...
import VendorGroupEdit from "./edit";
import { GetListingForVendorGroup, DeleteVendorGroupDataById } from "..//shared/vendorgroup";
import AddVenderGroup from "./add";
...
let VendorGroupListing = () => {
  ...
  async function getlistapi() {
    await GetListingForVendorGroup(Page, PageSize).then(res => {
  ...
  async function Dellistapi() {
    await DeleteVendorGroupDataById(idofEdit)
      .then(() => {
        success();
      })
      .catch(error => {
  ...
  if (menushow) {
    menuDiv = (
      <ul className="tool">
        <li>
          <AddVenderGroup refresh={refreshfn} />
        </li>
    ...
    <div>
      <div className="row header">
        ...
        <div className="col-12 col-sm-6 col-md-7 col-lg-7 col-xl-7">
          <h3 className="heading">VENDOR GROUP</h3>
        </div>
      </div>
      <br />
      {EditshowModel}
...
export default VendorGroupListing;
