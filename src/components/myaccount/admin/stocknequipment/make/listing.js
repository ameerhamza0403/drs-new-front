...
import EditMake from "./edit";
import { GetListingForMake, DeleteMakeDataById } from "..//shared/make";
import AddMake from "./add";
...
let MakeListing = () => {
  ...
  async function getlistapi() {
    await GetListingForMake(Page, PageSize).then(res => {
  ...
  async function Dellistapi() {
    await DeleteMakeDataById(idofEdit)
      .then(() => {
        success();
      })
      .catch(error => {
