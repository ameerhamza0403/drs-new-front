import { GetModelDataById, PutModelDataById } from "../shared/model";
...
import {PostListingForFileUpload} from '../shared/make';
...
let [pCategory, setPCategory] = useState([
    ...
    const { data: editvalues } = await GetModelDataById(props.IDforAPI);
  ...
  async function onSubmit(values, { setSubmitting, setErrors }) {
    ...
    await PutModelDataById(props.IDforAPI, values).then(()=>success()).catch(error=>errort());
    handleOpen();
    props.refresh();
    setSubmitting(false);
  }
                        ...
                        <div className="row mb-2">
                          ...
                          <div className="col-12 col-sm-12 col-md-6 col-lg-9 col-xl-9">
                            <input
                              ...
                              defaultChecked={editvalues.consumable}
                              type="checkbox"
                            />
                            &nbsp;&nbsp;&nbsp;
                            <label
