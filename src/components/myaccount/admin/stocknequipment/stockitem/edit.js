...
import {
  GetStockItemDataById,
  PutStockItemDataById,
...
let EditStockItem = props => {
  ...
  async function onSubmit(values, { setSubmitting, setErrors }) {
    if (!(files === [])) {
      ...
      await PutStockItemDataById(props.IDforAPI,values)
  ...
  async function getlistapi() {
    ...
    const { data: initialValues } = await GetStockItemDataById(
      props.IDforAPI
    );
