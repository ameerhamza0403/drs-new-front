...
import { GetListingForStorageLocation, DeleteStorageLocationDataById } from "..//shared/storagelocation";
...
let StorageLocationListing = () => {
  ...
  async function getlistapi() {
    await GetListingForStorageLocation(Page, PageSize).then(res => {
  ...
  async function Dellistapi() {
    await DeleteStorageLocationDataById(idofEdit)
      .then(() => {
        success();
      })
      .catch(error => {
  ...
  function HandlerowSelect(row) {
    menuDiv = "";
    idofEdit = row.storageLocationId;
    ...
    <div>
      <div className="row header">
        ...
        <div className="col-12 col-sm-6 col-md-7 col-lg-7 col-xl-7">
          <h3 className="heading">STORAGE LOCATION</h3>
        </div>
      </div>
      <br />
      {EditshowModel}
...
export default StorageLocationListing;
