...
import {
  GetListingForPurchaseOrder,
  DeletePurchaseOrderDataById
} from "../shared/purchasegroup";
...
let PurchasegroupListing = () => {
    ...
    Tabledisplay = (
      ...
      <div>
        ...
        >
          ...
          <TableHeaderColumn dataField="fax" dataSort>
            Fax
          </TableHeaderColumn>
        </BootstrapTable>
        <br />
  ...
  async function getlistapi() {
    await GetListingForPurchaseOrder(Page, PageSize).then(res => {
  ...
  async function Dellistapi() {
    await DeletePurchaseOrderDataById(idofEdit)
      .then(() => {
        success();
      })
      .catch(error => {
  ...
  function HandlerowSelect(row) {
    menuDiv = "";
    idofEdit = row.purchasingGroupId;
  ...
  if (menushow) {
    menuDiv = (
      <ul className="tool">
        <li>
          <AddPurchaseOrder refresh={refreshfn} />
        </li>
    ...
    <div>
      <div className="row header">
        ...
        <div className="col-12 col-sm-6 col-md-7 col-lg-7 col-xl-7">
          <h3 className="heading">PURCHASE GROUP</h3>
        </div>
      </div>
      <br />
      {EditshowModel}
...
export default PurchasegroupListing;
