  ...
  if (Tabledistatus) {
    Tabledisplay = (
        ...
        >
          ...
          <TableHeaderColumn dataField="make" dataSort>
            Make
          </TableHeaderColumn>
          <TableHeaderColumn dataField="model" dataSort>
            Model
          </TableHeaderColumn>
...
//----- Finished Pagination---------
  ...
  function HandlerowSelect  (row) {
    menuDiv = "";
    idofEdit = row.manageMakesnModelId;
  ...
  if (menushow) {
    menuDiv = (
      <ul className="tool">
        <li>
          <AddManageMakesnModel refresh={refreshfn} />
        </li>
    ...
    <div>
      <div className="row header">
        ...
        <div className="col-12 col-sm-6 col-md-7 col-lg-7 col-xl-7">
          <h3 className="heading">MAKES & MODELS</h3>
        </div>
      </div>
      <br />
      {EditshowModel}
...
export default ManageMakesnModelListing;
