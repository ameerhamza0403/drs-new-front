import { GetProductCategoryDataById, PutProductCategoryDataById } from "..//shared/productcategory";
...
let EditProductCategory = props => {
  ...
  async function onSubmit(values, { setSubmitting, setErrors }) {
    await PutProductCategoryDataById(props.IDforAPI, values).then(()=>success()).catch(error=>errort());
    handleOpen();
    props.refresh();
    setSubmitting(false);
  }
