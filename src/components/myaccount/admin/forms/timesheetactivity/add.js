...
import {  PostListingForTimesheetActivity } from "../shared/timesheetactivity";
...
let AddTimesheetActivity = props => {
  ...
  async function onSubmit(values, { setSubmitting, setErrors }) {
    ...
    console.log(values);
    await PostListingForTimesheetActivity(values).then(()=>success()).catch(error=>errort());
    handleOpen();
    props.refresh();
    setSubmitting(false);
  }
  ...
  return (
    <div>
      ...
      <Modal
        ...
        size="lg"
      >
        <ModalHeader toggle={handleOpen} ><h3 className="font-weight:bold;">TimesheetActivity</h3></ModalHeader>
...
export default AddTimesheetActivity;
