import { GetTimesheetActivityDataById, PutTimesheetActivityDataById } from "../shared/timesheetactivity";
...
let EditTimesheetActivity = props => {
  let ColorCode = [
    "FFFFE0",
    "FFFACD",
    "FFEFD5",
...
export default EditTimesheetActivity;
