...
import EditTimesheetActivity from "./edit";
import {
  GetListingForTimesheetActivity,
  DeleteTimesheetActivityDataById
} from "..//shared/timesheetactivity";
import AddTimesheetActivity from "./add";
...
const options = {
  ...
  async function getlistapi() {
    await GetListingForTimesheetActivity(Page, PageSize).then(res => {
...
//----- Finished Pagination---------
  ...
  async function Dellistapi() {
    await DeleteTimesheetActivityDataById(idofEdit).then(() => {
      success();
    }).catch(error => {
        errort();
      });
  ...
  function HandlerowSelect  (row) {
    menuDiv = "";
    idofEdit = row.timesheetActivityId;
  ...
  if (menushow) {
    menuDiv = (
      <ul className="tool">
        <li>
          <AddTimesheetActivity refresh={refreshfn} />
        </li>
...
export default TimesheetActivityListing;
