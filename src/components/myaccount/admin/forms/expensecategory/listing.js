...
import {
  GetListingForExpenseCategory,
  DeleteExpenseCategoryDataById,
  PutExpenseCategoryDataById
} from "..//shared/expensecategory";
import AddExpenseCategory from "./add";
  ...
  if (Tabledistatus) {
    Tabledisplay = (
        ...
        >
          ...
          <TableHeaderColumn dataField="defaultVAT" dataSort>
            DefaultVAT
          </TableHeaderColumn>
          <TableHeaderColumn dataField="defaultCost" dataSort>
            Default Cost
          </TableHeaderColumn>
...
//----- Finished Pagination---------
  ...
  async function Dellistapi() {
    await DeleteExpenseCategoryDataById(idofEdit).then(() => {
      success();
    }).catch(error => {
        errort();
      });
  ...
  function HandlerowSelect  (row) {
    menuDiv = "";
    idofEdit = row.expenseCategoryId;
  ...
  if (menushow) {
    menuDiv = (
      <ul className="tool">
        <li>
          <AddExpenseCategory refresh={refreshfn} />
        </li>
    ...
    <div>
      <div className="row header">
        ...
        <div className="col-12 col-sm-6 col-md-7 col-lg-7 col-xl-7">
          <h3 className="heading">EXPENSE CATEGORY</h3>
        </div>
      </div>
      <br />
      {EditshowModel}
