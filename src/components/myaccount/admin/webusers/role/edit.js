import { GetRoleDataById, PutRoleDataById } from "..//shared/role";
...
let EditRole = props => {
  ...
  async function onSubmit(values, { setSubmitting, setErrors }) {
    await PutRoleDataById(props.IDforAPI, values).then(()=>success()).catch(error=>errort());
    handleOpen();
    props.refresh();
    setSubmitting(false);
  }
  ...
  return (
    <div>
      ...
      <Modal
        ...
        size="lg"
      >
        <ModalHeader toggle={handleOpen} ><h3 className="font-weight:bold;">Role</h3></ModalHeader>
