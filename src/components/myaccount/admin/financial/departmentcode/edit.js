import { GetDepartmentCodeDataById, PutDepartmentCodeDataById } from "..//shared/departmentcode";
...
let EditDepartmentCode = props => {
  ...
  async function onSubmit(values, { setSubmitting, setErrors }) {
    await PutDepartmentCodeDataById(props.IDforAPI, values).then(()=>success()).catch(error=>errort());
    handleOpen();
    props.refresh();
    setSubmitting(false);
  }
  ...
  return (
    <div>
      ...
      <Modal
        ...
        size="lg"
      >
        <ModalHeader toggle={handleOpen} ><h3 className="font-weight:bold;">DepartmentCode</h3></ModalHeader>
                        ...
                        <div className="row">
                          ...
                          <div className="col-12 col-sm-12 col-md-6 col-lg-9 col-xl-9 mb-3">
                            ...
                            <input
                              ...
                              invalid={touched.active && !!errors.isActive}
...
export default EditDepartmentCode;
