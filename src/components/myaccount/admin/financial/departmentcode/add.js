...
import {  PostListingForDepartmentCode } from "..//shared/departmentcode";
...
let AddDepartmentCode = props => {
  ...
  async function onSubmit(values, { setSubmitting, setErrors }) {
    console.log(values);
    await PostListingForDepartmentCode(values).then(()=>success()).catch(error=>errort());
    handleOpen();
    props.refresh();
    setSubmitting(false);
  }
