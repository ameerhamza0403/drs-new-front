...
import {  PostListingForSalesOpportunityStage } from "../shared/salesopportunitystage";
...
let AddSalesOpportunityStage = props => {
  ...
  async function onSubmit(values, { setSubmitting, setErrors }) {
    console.log(values);
    await PostListingForSalesOpportunityStage(values).then(()=>success()).catch(error=>errort());
    handleOpen();
    props.refresh();
    setSubmitting(false);
  }
...
export default AddSalesOpportunityStage;
