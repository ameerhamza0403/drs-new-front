...
let EditButtonforSaleOppProb = props => {
  let ColorCode = [
    "FFFFE0",
    "FFFACD",
    "FFEFD5",
  ...
  async function onSubmit(values, { setSubmitting, setErrors }) {
    ...
    await PutSaleProbDataById(props.IDforAPI, values).then(()=>success()).catch(error=>errort());
    handleOpen();
    props.refresh();
    setSubmitting(false);
  }
  ...
  async function getlistapi() {
    const { data: initialValues } = await GetSaleProbDataById(props.IDforAPI);
  ...
  return (
    <div>
      ...
      <Modal
        ...
        size="lg"
      >
        <ModalHeader toggle={handleOpen} ><h3 className="font-weight:bold;">SalesOpportunityFlag</h3></ModalHeader>
...
export default EditButtonforSaleOppProb;
