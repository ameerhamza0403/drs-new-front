...
import {  PostListingForNominalCode } from "..//shared/nominalcode";
...
let AddNominalCode = props => {
  ...
  async function onSubmit(values, { setSubmitting, setErrors }) {
    console.log(values);
    await PostListingForNominalCode(values).then(()=>success()).catch(error=>errort());
    handleOpen();
    props.refresh();
    setSubmitting(false);
  }
