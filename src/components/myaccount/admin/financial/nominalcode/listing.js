...
import EditNominalCode from "./edit";
import {
  GetListingForNominalCode,
  DeleteNominalCodeDataById
} from "..//shared/nominalcode";
import AddNominalCode from "./add";
...
//----- Finished Pagination---------
  ...
  if (menushow) {
    menuDiv = (
      <ul className="tool">
        <li>
          <AddNominalCode refresh={refreshfn} />
        </li>
...
export default NominalCodeListing;
