import { GetSalesOpportunityFlagDataById, PutSalesOpportunityFlagDataById } from "../shared/salesopportunityflag";
...
let EditSalesOpportunityFlag = props => {
  let ColorCode = [
    "FFFFE0",
    "FFFACD",
    "FFEFD5",
...
export default EditSalesOpportunityFlag;
