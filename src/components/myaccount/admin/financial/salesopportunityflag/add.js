...
import {  PostListingForSalesOpportunityFlag } from "../shared/salesopportunityflag";
...
let AddSalesOpportunityFlag = props => {
  ...
  async function onSubmit(values, { setSubmitting, setErrors }) {
    ...
    console.log(values);
    await PostListingForSalesOpportunityFlag(values).then(()=>success()).catch(error=>errort());
    handleOpen();
    props.refresh();
    setSubmitting(false);
  }
...
export default AddSalesOpportunityFlag;
