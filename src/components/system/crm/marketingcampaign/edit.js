...
import {
  GetCrmMarkCampaignById,
  PutCrmMarkCampaign
} from "..//shared/marketingcampaign";
...
let EditCrmMarketingCampaigns = props => {
  ...
  async function onSubmit(values, { setSubmitting, setErrors }) {
    if (!(values.startDate === null)) {
      if (values.startDatemodified === undefined) {
        ...
        values.startDate = `${values.startDate}T${values.startDatemodified}`;
      }
    }
    if (!(values.endDate === null)) {
      if (values.endDatemodified === undefined) {
        ...
        values.endDate = `${values.endDate}T${values.endDatemodified}`;
      }
    }
    if (!(values.proposedStartDate === null)) {
      if (values.proposedEndDatemodified === undefined) {
        ...
        values.proposedStartDate = `${values.proposedStartDate}T${values.proposedStartDatemodified}`;
      }
    }
    if (!(values.proposedEndDate === null)) {
      if (values.proposedEndDatemodified === undefined) {
        ...
        values.proposedEndDate = `${values.proposedEndDate}T${values.proposedEndDatemodified}`;
      }
    }
    ...
    await PutCrmMarkCampaign(props.IDforAPI, values)
  ...
  async function getlistapi() {
    const { data: initialValues } = await GetCrmMarkCampaignById(props.IDforAPI);
    ...
    if (
      ...
      initialValues.startDatemodified = initialValues.startDate.substr(
        11,
        initialValues.startDate.length - 4
      );

      initialValues.startDate = initialValues.startDate.substr(
        0,
        initialValues.startDate.length - 9
      );
    }
    ...
    if (
      ...
      initialValues.endDatemodified = initialValues.endDate.substr(
        11,
        initialValues.endDate.length - 4
      );

      initialValues.endDate = initialValues.endDate.substr(
        0,
        initialValues.endDate.length - 9
      );
    }
    ...
    if (
      !(
        ...
        initialValues.proposedStartDate === undefined
      )
    ) {
      initialValues.proposedStartDatemodified = initialValues.proposedStartDatemodified.substr(
        11,
        initialValues.proposedStartDate.length - 4
      );

      initialValues.proposedStartDate = initialValues.proposedStartDate.substr(
        0,
        initialValues.proposedStartDate.length - 9
      );
    }
    ...
    if (
      !(
        ...
        initialValues.proposedEndDate === undefined
      )
    ) {
      initialValues.proposedEndDatemodified = initialValues.proposedEndDate.substr(
        11,
        initialValues.proposedEndDate.length - 4
      );

      initialValues.proposedEndDate = initialValues.proposedEndDate.substr(
        0,
        initialValues.proposedEndDate.length - 9
      );
    }
...
export default EditCrmMarketingCampaigns;
