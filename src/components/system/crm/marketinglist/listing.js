...
import { GetCrmMarketingList, DeleteCrmMarketingList } from "..//shared/marketinglist";
import AddMarkType from "./add";
...
let MarketingList = props => {
    ...
    Tabledisplay = (
      <div>
        ...
        >
          ...
          <TableHeaderColumn dataField="targetType" dataSort>
          Target Type
          </TableHeaderColumn>
          <TableHeaderColumn
            dataField="marketingListId"
  ...
  async function getlistapi() {
    await GetCrmMarketingList(Page, PageSize).then(res => {
  ...
  async function Dellistapi(id) {
    await DeleteCrmMarketingList(id)
      .then(() => {
        success();
      })
      .catch(error => {
